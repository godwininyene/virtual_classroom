...
export default function Parents({ auth }) {
                        ...
                        <div className=" text-gray-900 dark:text-gray-100">
                            ...
                            <div className="rounded-lg bg-white dark:bg-slate-800   overflow-x-auto shadow-sm shadow-white">
                                <h2 className="px-4 py-2 border-b font-semibold flex justify-between items-center">
                                    <span className="flex gap-2 items-center"> <FaChildren className="w-6 h-6 inline-block" />All Parents</span>
                                </h2>
                                <table className="w-full">
                                    
                                    <thead className='bg-sky-950 text-white text-left'>
                                        <th className="py-1 px-3 whitespace-nowrap">sn</th>
                                        <th className="py-1 px-3 whitespace-nowrap">Ward Photo</th>
                                        <th className="py-1 px-3 whitespace-nowrap">Name</th>
                                        <th className="py-1 px-3 whitespace-nowrap">Parent Name</th>
                                        <th className="py-1 px-3 whitespace-nowrap">Parent Phone</th>
                                        <th className="py-1 px-3 whitespace-nowrap">Parent Email</th>
                                    </thead>
...

                                       {
                                        students && students.map((student, index)=>(
                                            ...
                                            <tr  className="odd:bg-slate-100 dark:odd:bg-slate-800" key={student.id}>
                                                ...
                                                <td className="px-3 py-2">{student.parent_fullname}</td>
